...
export default class RLFennec
{
    constructor()
    {
        ...
        {
            this.debugFolder = this.debug.ui.addFolder('RLFennec')
        }

        
        this.resource = this.resources.items.rlFennec
    ...
    {        
        ...
        this.emptyFennec = this.model.children[0]
