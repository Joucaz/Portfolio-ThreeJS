...
export default class Breach
{
    constructor()
    {
        ...
        {
            this.debugFolder = this.debug.ui.addFolder('Breach')
        }

        
        this.resource = this.resources.items.breach
    ...
    setAnimation()
    {
        ...
        this.animation.actions.breachAction = this.animation.mixer.clipAction(this.resource.animations[0])
    ...
    playAnimation()
    {
        ...
        const action = this.animation.actions.breachAction;
    ...
    update()
    {
        ...
        if (this.isPlaying && this.animation.actions.breachAction.time >= this.resource.animations[0].duration) {
            this.isPlaying = false;
        }
    }
}