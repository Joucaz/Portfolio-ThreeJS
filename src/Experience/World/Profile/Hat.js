...
export default class Hat
{
    constructor()
    {
        ...
        {
            this.debugFolder = this.debug.ui.addFolder('Hat')
        }

        
        this.resource = this.resources.items.hat
    ...
    setAnimation()
    {
        ...
        this.animation.actions.hatAction = this.animation.mixer.clipAction(this.resource.animations[0])
    ...
    playAnimation()
    {
        ...
        const action = this.animation.actions.hatAction;
    ...
    update()
    {
        ...
        if (this.isPlaying && this.animation.actions.hatAction.time >= this.resource.animations[0].duration) {
            this.isPlaying = false;
        }
    }
}