...
export default class Ball
{
    constructor()
    {
        ...
        this.resource = this.resources.items.ball
    ...
    setAnimation()
    {
        ...
        this.animation.actions.ballAction = this.animation.mixer.clipAction(this.resource.animations[0])
    ...
    playAnimation()
    {
        ...
        const action = this.animation.actions.ballAction;
    ...
    update()
    {
        ...
        if (this.isPlaying && this.animation.actions.ballAction.time >= this.resource.animations[0].duration) {
            this.isPlaying = false;
        }
    }
}